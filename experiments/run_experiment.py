...
def main():
    ...
    ap.add_argument("--size-beta", type=float, default=1.0)
    ap.add_argument("--size-clip", action="store_true")
    ...
    cfg = {
        ...
        "eval_every": args.eval_every, "eval_cap": args.eval_cap, "size_beta": args.size_beta, "size_clip": args.size_clip, "buffer_k": args.buffer_k, "staleness_a": 0.5,
